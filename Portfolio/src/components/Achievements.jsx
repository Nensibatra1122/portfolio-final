...
const galleryImages = [
  ...
  // Naya FlyRank AI ka milestone yahan add kar diya hai:
  { 
    id: 6, 
    src: "/flyrank_acceptance.jpg", 
    title: "Machine Learning Cohort — FlyRank AI", 
    desc: "Accepted into the specialized Machine Learning engineering cohort to collaborate on advanced AI frameworks and predictive pipelines." 
  }
];
...
export default function Gallery() {
  ...
  return (
    // id="achievements" add kar di hai taake click karne par scroll ho sake
    <section className="py-24 bg-gradient-to-b from-gray-950 to-gray-900 text-white" id="achievements">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((item, index) => (
            <motion.div
              ...
              className="relative rounded-2xl p-5 min-h-[220px] flex flex-col justify-between border border-cyan-500/20 bg-gray-950/90 shadow-2xl transition-all duration-300 hover:border-cyan-400 cursor-pointer"
            >
